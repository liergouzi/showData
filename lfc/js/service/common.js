app.factory('PATH', function ($http, ENV) {
    ...
    return {
        ...
        getIndex: ENV.api + "/ctrl/station/getIndex",

        getarticle:function (id) {
            return ENV.api+"/rest/dynamicInformation/"+id;
        },
        ...
        updateRole: ENV.api + "/ctrl/role/updateRole",
        getRolePrivilege: function (id) {
            return ENV.api + "/sign/privilege/getAll/" + id;
        },
        setPrivilege: function (roleId, privilegeids) {
            return ENV.api + "/ctrl/role/setPrivilege/" + roleId + "/" + privilegeids;
        },
        ...
        users: {
            ...
            loadUserWithRole: function (id) {
                return ENV.api + "/ctrl/user/getUserWithPrivilege/" + id;
            },
            setUserRole: function (userId, roleId, doing) {
                return ENV.api + "/ctrl/user/setRole/" + userId + "/" + roleId + "/" + doing;
            },
            setUserPrivilege: function (userId, privilegeId, doing) {
                return ENV.api + "/ctrl/user/setPrivilege/" + userId + "/" + privilegeId + "/" + doing;
            },
        },
        dict: {
        ...
        periods_settings: {
            getPeriods: function (y, m) {
                return ENV.api + "/ctrl/taskCheckOutPlan/" + y + "/" + m;
            },
            setPeriods: ENV.api + "/ctrl/taskCheckOutPlan/setTaskPlan",
            batchSetperiods: function (y, m, c) {
                return ENV.api + "/ctrl/taskCheckOutPlan/setTaskPlan/" + y + "/" + m + "/" + c;
            },
            periodsCatalogue: function (y) {
                return ENV.api + "/ctrl/taskCheckOutPlan/" + y;
            }

        },
        //检查loginId是否重复
        checkLoginId: function (loginid, id) {
            return ENV.api + "/rest/user?filter.loginId=" + loginid + "&filter.id$$NEQ=" + id;
        }
    }
});
